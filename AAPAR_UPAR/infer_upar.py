...
from dataset.pedes_attr.pedes import PedesAttr, PedesAttrUPAR, PedesAttrUPARInfer
...
def main(cfg, args):
    ...
    valid_set = PedesAttrUPARInfer(cfg=cfg, csv_file='/data3/doanhbc/upar/annotations/phase1/val_task1/val.csv', transform=valid_tsfm,
